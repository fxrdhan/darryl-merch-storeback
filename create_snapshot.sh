...
# Output file name
OUTPUT_FILE="storeback_snapshot.txt"
# Patterns to exclude for the tree command
TREE_EXCLUDE_PATTERN=".git|.github|.next|.yarn|node_modules|yarn.lock|.gitignore|README.md|${OUTPUT_FILE}|storeback_snapshot.sh|*.png|*.jpg|*.jpeg|*.gif|*.svg|*.ico"
